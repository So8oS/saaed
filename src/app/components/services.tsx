...
const services = [
  {
    ...
    "description": "Tailored programs for team development and improving work culture.",
    "icon": "puzzle-piece.png"
  },
  {
    "service": "Mental & Professional Health",
    "description": "Workshops focused on mental health awareness and stress management.",
    "icon": "graduation-cap.png"
  },
  {
    "service": "Communication Coaching",
    "description": "Training to enhance clarity and effectiveness in communication.",
    "icon": "speak.png"
  },
  {
  ...
  },
  {
    ...
    "description": "Strengthening interpersonal relationships and communication skills.",
    "icon": "team.png"
  },
  {
  ...
  },
  {
    ...
    "description": "Guidance for achieving personal growth, balance, and fulfillment.",
    "icon": "person.png"
  }
];
...
const nums = [
  ...
  import { FaGraduationCap, FaHospital, FaLaptopCode, FaUtensils, FaRocket, FaHandsHelping, FaFemale } from 'react-icons/fa';

const sectors = [
  { title: "Education", icon: <FaGraduationCap className='w-6 h-6' />, description: "We provide educational solutions and support." },
  { title: "Healthcare and Pharmaceuticals", icon: <FaHospital className='w-6 h-6' />, description: "We serve the healthcare and pharmaceutical sectors." },
  { title: "Information Technology", icon: <FaLaptopCode className='w-6 h-6' />, description: "We offer IT services and solutions." },
  { title: "Food, Tourism, and Hospitality", icon: <FaUtensils className='w-6 h-6' />, description: "We work with the food, tourism, and hospitality industries." },
  { title: "Startups", icon: <FaRocket className='w-6 h-6' />, description: "We support startups in their growth and development." },
  { title: "Charities, Clinics, and Psychiatric Centers", icon: <FaHandsHelping className='w-6 h-6' />, description: "We assist charities, clinics, and psychiatric centers." },
  { title: "Women's Empowerment Institutions and Centers", icon: <FaFemale className='w-6 h-6' />, description: "We empower women through various institutions and centers." },
];
  ...
  return (
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 px-4">
      {services.map((service, index) => (
        ...
        ">
          <img src={`${service.icon}`} alt={service.service} className="w-16 h-16 mb-4 "/>
          <h3 className="text-xl font-semibold mb-2 text-center">{service.service}</h3>
      ...
      <div className="grid gap-8 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1">
        {sectors.map((sector, index) => (
          ...
          >
            ...
            <div>
              <div className="text-xl font-medium text-black">{sector.title}</div>
